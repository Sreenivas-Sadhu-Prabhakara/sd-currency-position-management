package com.bank.bian.currencypositionmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Currency Position Management Plan".
 *
 ...
 * to its asset type (Currency Position). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Currency Position Management Plan";
